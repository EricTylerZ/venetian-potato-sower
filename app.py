...
def estimate():
    ...
    chunk_size_tokens = max_context_tokens - (prompt_tokens + message_overhead + 150)
...
def process():
    ...
    def generate():
        ...
        chunks = split_into_chunks(chat_text, num_chunks, max_context_tokens, prompt_tokens, message_overhead)
